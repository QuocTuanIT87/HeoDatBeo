...
const DeletedCategoriesScreen = () => {
  ...
  const handleRestoreExpense = async (catId: string, catName: string) => {
    Alert.alert(
      t("deletedCategories.restoreTitle"),
      t("deletedCategories.restoreExpenseConfirm", { name: catName }),
      [
        { text: t("common.cancel"), style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (success) {
              Alert.alert(t("common.success"), t("deletedCategories.restoreSuccess", { name: catName }));
              loadData();
            } else {
              Alert.alert(t("common.error"), t("deletedCategories.restoreError"));
            }
          },
        },
      ]
  ...
  const handleRestoreIncome = async (catId: string, catName: string) => {
    Alert.alert(
      t("deletedCategories.restoreTitle"),
      t("deletedCategories.restoreIncomeConfirm", { name: catName }),
      [
        { text: t("common.cancel"), style: "cancel" },
        {
          text: t("common.confirm"),
                    ...
                    <View key={tx.id} style={styles.txItem}>
                      <View style={styles.txItemLeft}>
                        <Text style={styles.txName}>
                          {resolveCategoryName(tx, profile, categoryBudgets, t)}
                        </Text>
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.headerTitle}>{t("deletedCategories.title")}</Text>
        </View>
      </View>
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>
                {activeTab === "expense"
                  ? t("deletedCategories.emptyExpense")
                  : t("deletedCategories.emptyIncome")}
              </Text>
            </View>
          }
        />
