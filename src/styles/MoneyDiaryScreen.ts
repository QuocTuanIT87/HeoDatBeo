...
export const styles = StyleSheet.create({
    ...
    noteModalConfirmText: {
        color: "#ffffff",
        fontWeight: "bold",
        fontSize: 15,
    },
    manualInputModalOverlay: {
        flex: 1,
        backgroundColor: "rgba(15, 23, 42, 0.65)",
        justifyContent: "center",
        alignItems: "center",
